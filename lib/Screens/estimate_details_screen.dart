...
class _EstimateDetailsScreenState extends State<EstimateDetailsScreen> {
           ...
           Padding(
             ...
             child: Row(
              children: [
                ...
                Icon(Icons.close,color: AppColors.primaryColors,)
              ],
                     ),
           )
        ],
            ...
            children: [
              ...
              style: TextStyle(
                ...
                const Padding(
                  ...
                  child: Text('Confirm the details before submitting',
                              style: TextStyle(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Icon(Icons.more_horiz,color: AppColors.primaryColors,)
                    ],
                  ),
                ),
                      ...
                      subTitleWidget("Estimate Notes"),
                       Padding(
                        ...
                        child:  GestureDetector(
                          ...
                          child:  Icon( isEstimateNotes? Icons.keyboard_arrow_down_rounded : Icons.keyboard_arrow_up_rounded,size: 32,)),
                      )
                    ],
                  ),
                ),
                      ...
                      subTitleWidget("Appointment"),
                       Padding(
                        ...
                        child:  GestureDetector(
                          ...
                          child:  Icon( isAppointment? Icons.keyboard_arrow_down_rounded : Icons.keyboard_arrow_up_rounded,size: 32,)),
                      )
                    ],
                  ),
                ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Icon( isInspectionPhotos? Icons.keyboard_arrow_down_rounded : Icons.keyboard_arrow_up_rounded,size: 32,)),
                    ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Icon( isService? Icons.keyboard_arrow_down_rounded : Icons.keyboard_arrow_up_rounded,size: 32,)),
                    ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            padding:  EdgeInsets.only(top:8.0),
            child: Text("Anthony Miller",style: TextStyle(
              fontSize: 16,
              color: AppColors.primaryTitleColor,
              fontWeight: FontWeight.w400
            ),),
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text("Anthonymiller@gmail.com",style: TextStyle(
                  fontSize: 16,
                  color: AppColors.primaryTitleColor,
                  fontWeight: FontWeight.w400
                ),),

                SvgPicture.asset("assets/images/mail_icons.svg",color:AppColors.primaryColors,)
              ],
            ),
          ),
           ...
           Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text("(786) 000-0000",style: TextStyle(
                  fontSize: 16,
                  color: AppColors.primaryTitleColor,
                  fontWeight: FontWeight.w400
                ),),
                ...
                Row(
                  children: [
                    SvgPicture.asset("assets/images/sms_icons.svg",color:AppColors.primaryColors,),
                    Padding(
                      padding: const EdgeInsets.only(left:34.0),
                      child: SvgPicture.asset("assets/images/phone_icon.svg",color:AppColors.primaryColors,),
                    ),
                  ],
                )
              ],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            padding:  EdgeInsets.only(top:8.0),
            child: Text("McLaren 765LT, 2022",style: TextStyle(
              fontSize: 16,
              color: AppColors.primaryTitleColor,
              fontWeight: FontWeight.w400
            ),),
          ...
          child: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("10/10/2023 - 3:34 PM",
                  style: TextStyle(
                    color: Color(0xff6A7187),
                    fontSize: 14,
                    fontWeight: FontWeight.w500
                  ),),
                  Icon(Icons.more_horiz,color: AppColors.primaryColors,)
                ],
              ),
                ...
                Text("John Doe",
                  style: TextStyle(
                    ...
                    Text("This is a note entry for the vehicle, it can be multiple lines tall.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 14,
                    fontWeight: FontWeight.w500,
  ...
  Widget appointmentDetailsWidget(){
          ...
          Row(
           ...
           Padding(
            ...
            Padding(
             ...
             Padding(
              padding: const EdgeInsets.only(top:16.0),
              child: appointmentLabelwithValue("Appointment note","Customers girlfriend will drop the car off."),
            ),
    ...
    return SizedBox(
      width: label=="Appointment note"?MediaQuery.of(context).size.width: MediaQuery.of(context).size.width/2.3,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
