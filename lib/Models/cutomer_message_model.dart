...
CustomerMessageModel customerMessageModelFromJson(String str) => CustomerMessageModel.fromJson(json.decode(str));
...
class CustomerMessageModel {
    ...
    factory CustomerMessageModel.fromJson(Map<String, dynamic> json) => CustomerMessageModel(
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        senderUserId: ErId.fromJson(json["sender_user_id"]),
        receiverCustomerId: ErId.fromJson(json["receiver_customer_id"]),
